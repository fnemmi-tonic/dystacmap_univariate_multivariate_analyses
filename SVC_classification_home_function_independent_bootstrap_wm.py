...
gm_val_nuisance_removed_norm = normalize(gm_val_nuisance_removed, axis = 0)
gm_val_nuisance_removed_norm_no_td = gm_val_nuisance_removed_norm[label != 1, :]
...
import pickle
with open('wm_val_nuisance_removed_norm_no_td.pkl', 'wb') as f:
...
with open("wm_results_100.pkl", "wb") as f:
